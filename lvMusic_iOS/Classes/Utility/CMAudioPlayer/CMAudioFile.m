...
- (NSArray *)parseData:(BOOL *)isEof
{
    ...
    if (ioNumPackets > 0)
    {
        ...
        for (int i = 0; i < ioNumPackets; ++i)
        {
            ...
            CMParsedAudioData *parsedData = [CMParsedAudioData parsedAudioDataWithBytes:outBuffer + packetDescription.mStartOffset
...
static OSStatus MCAudioFileReadCallBack(void *inClientData,
                                        ...
                                        UInt32 *actualCount)
{
    CMAudioFile *audioFile = (__bridge CMAudioFile *)inClientData;
